...
- name: Mota Word - Get a list of realtime activities.
  x-api-slug: projectsprojectidactivities-get
...
- name: Mota Word - Get a single realtime activity.
  x-api-slug: projectsprojectidactivitiesactivityid-get
...
- name: Mota Word - Submit a comment to an activity.
  x-api-slug: projectsprojectidactivitiesactivityid-post
...
- name: Mota Word - Get a list of comments belonging to this activity.
  x-api-slug: projectsprojectidactivitiesactivityidcomments-get
  ...
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/activities/master/_listings/motaword/projectsprojectidactivitiesactivityidcomments-get-openapi.md
x-common:
- type: x-website
