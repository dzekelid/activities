...
created: "2018-05-20"
modified: "2018-05-20"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/activities/master/_listings/yammer/apis.md
specificationVersion: "0.14"
apis:
- name: Yammer API Get View Activities
  x-api-slug: yammer-api
  description: Get View Activities
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/535_logo.png
  humanURL: http://developer.yammer.com
  baseURL: ://example.com///{yamURI}/streams/activities.json
  tags: Activities
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/activities/master/_listings/yammer/yamuristreamsactivitiesjson-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/activities/master/_listings/yammer/yamuristreamsactivitiesjson-get-openapi.md
- name: Yammer API
  x-api-slug: yammer-api
  description: Discuss ideas, share updates, and crowdsource answers from coworkers
    around the globe. Yammer gives your team a faster, smarter way to connect and
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/activities/master/_listings/yammer/openapi.md
x-common:
- type: x-website
